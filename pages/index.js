...
*
* Name: Nikita Sachivko Student ID: 165495193 Date: 12/4/2022
*
*
********************************************************************************/
    ...
    <>
      <Container>
        <NextImage
          ...
          placeholder="blur"
          blurDataURL={"https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg"}
        />
        <Row className="text-black mt-5">
          <Col >
          ...
          <Col>
            ...
            <a className="text-success"
              href="https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art" target="_blank" rel="noreferrer">https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art</a>
          </Col>
        </Row>
      </Container>
    </>
